...
/**
 * Feature 조회 레이어 타입
 * extendLayers의 code와 매칭됩니다.
 */
typedef NS_ENUM(NSInteger, VSMMapExtendLayerType) {
    /** 알 수 없는 Extend Layer */
    VSMMapExtendLayerTypeUnknown = 0,
    /** 소셜 리포트 레이어 */
    VSMMapExtendLayerTypeSocialReport = 1,
    /** 차단도로 레이어 */
    VSMMapExtendLayerTypeBlockRoad = 2,
    /** 교통정보 레이어 */
    VSMMapExtendLayerTypeTraffic = 3,
    /** 사고정보 레이어 */
    VSMMapExtendLayerTypeAccident = 4,
    /** CCTV 레이어 */
    VSMMapExtendLayerTypeCctv = 5,
    /** 3D 모델 레이어 */
    VSMMapExtendLayerTypeThreeDModel = 6,
    /** 주차장 레이어 */
    VSMMapExtendLayerTypeParkingLot = 7,
    /** 주차장 구역 레이어 */
    VSMMapExtendLayerTypeParkingLotZone = 8,
    /** 실시간 가는 중 레이어 */
    VSMMapExtendLayerTypeRTDriveCount = 9
};
...
typedef NS_ENUM(NSInteger, MapTrackMode)
{
    /** 일반 지도 이동 모드
     */
    MapTrackModeNormal = 0,
    /** 현위치가 지도 중심
     */
    MapTrackModeTrack = 1,
    /** 현위치가 지도 중심 + 현위치 bearing이 지도 상단
     */
    MapTrackModeTrackAndHeadUp = 2,
    /** 현위치가 지도 중심 + 현위치 bearing이 지도 상단(Headup 변경 시 애니메이션)
     */
    MapTrackModeTrackAndHeadUpWithAnim = 3
};
